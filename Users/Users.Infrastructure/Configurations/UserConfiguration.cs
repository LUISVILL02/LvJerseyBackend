...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.HasIndex(e => e.Nickname).IsUnique().HasDatabaseName("Users_nikname_key");
        ...
        builder.Property(e => e.Nickname).HasColumnType("character varying").HasColumnName("nickname");
        ...
        builder.Property(e => e.EmailConfirmed).HasColumnType("bool").HasColumnName("email_confirmed");
